...
function poi_form() {
    ...
    /*} else if (subject == "請選擇" || subject == "" || subject == null) {
        $('.alert-danger').empty();
        $('.alert-danger').show();
        if (languages == "chinese") {
            $('.alert-danger').append("<p>主題尚未選擇</p>");
        } else if (languages == "english") {
            $('.alert-danger').append("<p>The subject has not been selected yet</p>");
        } else if (languages == "japanese") {
            $('.alert-danger').append("<p>件名はまだ選択されていません</p>");
        }
        document.getElementById("subject").style.border = "solid 1px #F00 ";*/
    ...
    /*} else if (type1 == null){
        ...
        $('.alert-danger').show();
        if (languages == "chinese") {
            $('.alert-danger').append("<p>類型尚未選擇</p>");
        } else if (languages == "english") {
            $('.alert-danger').append("<p>The type has not been selected yet</p>");
        } else if (languages == "japanese") {
            $('.alert-danger').append("<p>タイプはまだ選択されていません</p>");
        }
        document.getElementById("type1").style.border = "solid 1px #F00 ";*/
    } else if (period == null){
        $('.alert-danger').empty();
        $('.alert-danger').show();
        if (languages == "chinese") {
                    ...
                    if (data.media != "0" && data.sounds != "0") {
                        ...
                        switch (data.media) {
                            case "1":
                                ...
                                break;
                            case "2":
                                alert("upload audio successfully");
